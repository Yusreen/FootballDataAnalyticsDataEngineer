...
def write_wikipedia_data(**kwargs):
    ...
    #j9oVSuT7SG8geN4Vow1ClXfxByxuBQa3oEcMhMAcWLcnJRzpoXBg4SFywqEplNQYXkgHCi1T1/eB+AStqVkoYA==
    data.to_csv('abfs://footballdataeng@footballdataeng.dfs.core.windows.net/data/' + file_name,
                storage_options={
                    'account_key': 'j9oVSuT7SG8geN4Vow1ClXfxByxuBQa3oEcMhMAcWLcnJRzpoXBg4SFywqEplNQYXkgHCi1T1/eB+AStqVkoYA=='
                }, index=False)
